...
function validateForm() {
  ...
  isValid = form.checkValidity(); // hemme zat doldurulan bolsa true, dal bolsa false chykaryar.
  ...
  if (!isValid) {
    ...
    return; // Bularyn manysy formda kemchilik bar bolsa bize yalnysh diyip chykarmagy ucin 
  }
